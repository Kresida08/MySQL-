...
(6,"RHEA",10,"HM","CANTEEN SERVICE")
  ...
  #WE CAN RENAME RECYCLE BIN AS PER OUR WANT.
...
#THE ABOVE PART IS FOR RECYCLE BIN CREATION. THE TRIGGER STARTS BELOW.
  
DELIMITER $     #(DELIMITER CAN BE ANY SYMBOL, BUT REMEMBER TO END IT ONCE U START THE DELIMITER.)
CREATE TRIGGER DELETE_DATA        #(TRIGGER NAME CAN ALSO BE GIVEN AS PER YOUR CHOICE.)
...
SELECT * FROM RECYCLE_BIN
  #MAKE SURE YOU SET THE SAFE UPDATE TO 0.
